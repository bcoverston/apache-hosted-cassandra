    ...
    */
    ...
    public static PaxosState loadPaxosState(DecoratedKey key, CFMetaData metadata)
    {
        ...
        Commit promised = row.has("in_progress_ballot")
                        ? new Commit(row.getUUID("in_progress_ballot"), new PartitionUpdate(metadata, key, metadata.partitionColumns(), 1, nowInSec))
    ...
    public static void updateSizeEstimates(String keyspace, String table, Map<Range<Token>, Pair<Long, Long>> estimates)
    {
        ...
        int nowInSec = FBUtilities.nowInSeconds();
        PartitionUpdate update = new PartitionUpdate(SizeEstimates, key, SizeEstimates.partitionColumns(), estimates.size(), nowInSec);
