...
interface Restrictions
{
    ...
    /**
     * Adds to the specified column filter the expressions corresponding to this <code>Restrictions</code>.
     *
     * @param filter the column filter to add expressions to
     * @param indexManager the secondary index manager
     * @param options the query options
     * @throws InvalidRequestException if this <code>Restrictions</code> cannot be converted into a column filter
     */
